...
#else ifeq ($(OSCAM_FLAVOUR), oscam-patched)
OSCAM_FLAVOUR_URL = https://github.com/oscam-emu/oscam-patched.git
OSCAM_FLAVOUR_DIR = oscam-patched.git
OSCAM_SOURCE_DIR  = oscam-patched
OSCAM_PULL        = git pull
OSCAM_CLONE       = git clone
#endif
...
$(D)/oscam: $(D)/bootstrap $(D)/openssl $(D)/libusb oscam.do_prepare oscam.do_compile
	...
	cp -pR $(SOURCE_DIR)/$(OSCAM_SOURCE_DIR)/Distribution/* $(TARGET_DIR)/../build_oscam/
	$(REMOVE)/oscam
	$(TOUCH)
