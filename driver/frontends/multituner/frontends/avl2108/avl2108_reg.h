...
#define TUNER_LOCKED               0x01

#define FUNC_MODE_DEMOD            0x00
#define FUNC_MODE_BLIND            0x01

#define LOCK_MODE_FIXED            0x00
#define LOCK_MODE_ADAPTIVE         0x01

/* RF AGC Polarisation */
#define AGC_POL_NORMAL             0x00
#define AGC_POL_INVERT             0x01
...
/* MPEG data */
#define MPEG_FORMAT_TS                  0x00  /*< Transport stream */
#define MPEG_FORMAT_TS_PAR              0x01  /*< Transport stream + Parity */

#define MPEG_MODE_PARALLEL              0x00  /*< Output parallel data */
#define MPEG_MODE_SERIAL                0x01  /*< Output serial data */

#define MPEG_CLK_MODE_FALLING           0x00  /*< MPEG data sampled on clock's falling edge */
#define MPEG_CLK_MODE_RISING            0x01  /*< MPEG data sampled on clock's rising edge */
